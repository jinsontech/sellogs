        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">ADD COMMENT</h4>
            ...
            <!-- / Content -->
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"> COMMENTS</h4>
                @if(!$comments->isEmpty())
                    ...
                    <!-- Basic Layout -->
                        <div class="row">
                            ...
                            <div class="card mb-8">
                                ...
                                <h5 class="mb-0">{{$comment->authorable->username}}</h5>
                                <small class="text-muted float-end">{{$comment->authorable_type}}</small>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                    <label class="form-label" for="basic-default-email">{{$comment->comment}}</label>
                                    </div>
                                </div>
                            </div>
                            </div>
